...
import com.example.movie_rental.usecases.ReadActor;
import com.example.movie_rental.usecases.UpdateActor;
...
public class ActorsController {
    ...
    ReadActor readActor;
    public ActorsController(CreateActor createActor, UpdateActor updateActor, ReadActor readActor) {
